...
\lstinputlisting[caption={tail -f syslog output}]{documents/syslog.log}
...
%\lstinputlisting[caption={usb_desc.h}]{documents/usb_desc.h}
...
\lstinputlisting[caption={tail -f syslog output 2}]{documents/syslog_2.log}
